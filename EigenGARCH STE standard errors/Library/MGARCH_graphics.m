...
if isequal(graph_type,'desc') || isequal(graph_type,'all')
    ...
    sgtitle('Autocorrelation of log returns');
    n=n+1;
    ...
    sgtitle('Autocorrelation of squared log returns');
    n=n+1;
...
%     n=n+1;
    ...
    sgtitle('Autocorrelation of std. residuals');
    n=n+1;    
    ...
    sgtitle('QQ plot of std. residuals');
    n=n+1;
    ...
    sgtitle('Density of std. residuals');
    n=n+1;
end
...
if isequal(graph_type, 'all') || isequal(graph_type, 'vol')
    ...
    sgtitle('Annualized standard deviations');
    n=n+1;
